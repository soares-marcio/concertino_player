...
const precacheResources = [
    ...
    '/img/check.png',
    '/img/slider_gr_left.png',
    '/img/cancel-on.png',
    '/img/history_big_wt.png',
    '/img/back.png',
